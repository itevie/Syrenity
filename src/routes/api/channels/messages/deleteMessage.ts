...
const handler: RouteDetails = {
    ...
    handler: async (req, res) => {
        ...
        const guild = channel.guild_id !== null ? await actions.guilds.fetch(channel.guild_id) : null;
            ...
            if (!gotPermission) {
                return res.status(401).send(new AuthenticationError({
                    ...
                    data: {
                        ...
                        bitfieldString: bitfieldToStringArray(permissionsBitfield.ManageMessages),
                    }
                }).extract());
            }
        }
