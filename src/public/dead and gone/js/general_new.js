...
const stuff = {
    ...
    modals: {
        ...
        showModal: async (name, data = { values: {} }) => {
            ...
            try {
                ...
                if (!data.smallModal)
                    modalDiv.classList.add("big-modal");
                modalDiv.innerHTML = html;
                container.appendChild(modalDiv);
                // Find data-hide-modal
                const hiders = div.querySelectorAll("[data-modal-hide]");
                ...
                const ids = div.querySelectorAll("[data-modal-id]");
                const elemIDs = {};
                for (const i of ids) {
                ...
                const uploadPfps = div.querySelectorAll("[data-modal-upload-pfp]");
    ...
    avatar: {
        ...
        setNoAvatarIcon: (userId, element) => {
