...
import ContextMenu from "../../dawn-ui/components/ContextMenu";
    ...
    <ContextMenu
      options={{
        elements: [
          ...
          {
            type: "submenu",
            label: trans("message.action.copy"),
            menu: {
              elements: [
                {
                  type: "button",
                ...
                },
                {
                  ...
                  onClick: () => {
                    window.navigator.clipboard.writeText(
                      options.message.id.toString(),
                    );
                  },
                },
                {
                  type: "button",
                  label: trans("message.action.copyTimestamp"),
                  onClick: () => {
                    window.navigator.clipboard.writeText(
                      options.message.createdAt.getTime().toString(),
                    );
                  },
                },
              ],
